      ...
      >
        ...
        <Box flex={1}>
          ...
          <TextField
            ...
            multiline
            rows={3}
            placeholder="Type your message (use <FIRST_NAME>, <MANAGER_FIRST_NAME>, <COMPANY_NAME> for templates)"
            value={message}
          ...
          >
            ...
            <Select
              ...
              onChange={(e) =>
                setScheduleTime(scheduleTime.hour(Number(e.target.value)))
              }
              sx={{ width: 80 }}
            >
              {[...Array(12)].map((_, i) => (
            ...
            <Select
              ...
              onChange={(e) =>
                setScheduleTime(scheduleTime.minute(Number(e.target.value)))
              }
              sx={{ width: 80 }}
            >
              {[...Array(60)].map((_, i) => (
                  ...
                  {message ? (
                    <>
                      ...
                      >
                        ...
                        >
                          <Typography>
                            Hi there! This is a reply to your message.
                          </Typography>
                        </Box>
                      </Box>
                    </>
